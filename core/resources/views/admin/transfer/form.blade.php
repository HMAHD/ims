                            ...
                            <table class="productTable table border">
                                ...
                                <tbody>
                                    ...
                                    <tr class="product-row product-row-{{ $item->product->id }}" data-product_id="{{ $item->product->id }}">
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <input class="form-control quantity" name="products[{{ $loop->index }}][quantity]" data-id="{{ $item->product->id }}" data-qty="{{ $item->quantity }}" type="number" step="0.001" min="0.001" value="{{ $item->quantity }}" required>
