                                ...
                                <td>
                                    <div class="button--group">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            @endpermit
                                            @permit('admin.sale.invoice.thermal.pdf')
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('admin.sale.invoice.thermal.pdf', $sale->id) }}/?direct_print=1"
                                                    target="_blank">
                                                    <i class="la la-print"></i> @lang('Direct Print')
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('admin.sale.invoice.thermal.pdf', $sale->id) }}">
                                                    <i class="la la-download"></i> @lang('Thermal PDF')
                                                </a>
                                            </li>
                                            @endpermit
                                        </div>
