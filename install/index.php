	...
	<header class="py-3 border-bottom border-primary bg--dark">
		<div class="container">
			<div class="d-flex align-items-center justify-content-between header gap-3">
				...
				<a style="color:red;" href="https://nullcave.pro/members/indtech.15330/" target="_blank">Nullcave Community</a><h3 class="title">Easy Installer</h3>
			</div>
		</div>
	</header>
					...
					<div class="install-item">
						...
						<div class="box-item">
							...
							if ($action == 'result') {
								...
								if (@$response['error'] == 'ok') {
									echo '<h2 class="text-success text-uppercase mb-3">Your system has been installed successfully By NullCave!</h2>';
									if (@$response['message']) {
									...
									echo '<p class="text-danger lead my-5">Please delete the "install" folder from the server. Licensed By NullCave</p>';
									echo '<div class="warning"><a href="' . appUrl() . '" class="theme-button choto">Go to website and Enjoy</a></div>';
								} else {
									if (@$response['message']) {
